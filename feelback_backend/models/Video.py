...
class Video(BaseModel):
    ...
    trailer = db.relationship('Video', backref='reaction', remote_side=[id], lazy=True)
    ...
    def to_json(self, populate: Iterable = (), exclude_columns: Iterable = (), include_foreign_keys=False,
        ...
        json['reaction_id'] = self.reaction[0].id if self.reaction and len(self.reaction) > 0 else None
